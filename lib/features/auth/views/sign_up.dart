          ...
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                image: DecorationImage(image: const AssetImage(signUpContinueImage),
                fit: BoxFit.cover,
                ),
              ),
            ),
                ...
                child: SingleChildScrollView(
                  child: Column(children: [
                      ...
                      child: MaterialButton(
                       onPressed: (){
                        ...
                        ref 
                              ...
                              .signUpWithEmailAndPassword(email: _emailcontroller.text, 
                              password: _passwordcontroller.text
                              ).then((value) => Navigator.pushAndRemoveUntil(context, 
                              MaterialPageRoute(builder: (_) => SignUpInfo(email: _emailcontroller.text)), (route) => false)); 
                        }
                       },
                    ...
                    child: Row(
                      ...
                      children: [
                        Text("Do you have an account ?", style: TextStyle(color: textButtontextColor, fontSize: 14),
                        ),
                        TextButton(
                          onPressed: () => Navigator.push(context, MaterialPageRoute(builder: (_)=>const SignIn())),
                          child: Text("Sign In",style: TextStyle(color: activeColor, 
                          fontSize: 14)) ,),
                      ],
                    ),
                    ),
